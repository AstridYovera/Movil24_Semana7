...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner spnSelector;
    String [] arreglos = {  "Tu obligación no es ser campeón del mundo, tu obligación es saber cuál es la idea",
                            "Se puede perder un partido, pero lo que no se puede perder es la dignidad por jugar bien al fútbol",
                            "Se puede dejar de correr, lo único que no se puede hacer es dejar de pensar”"};
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 1://orange
                        ...
                        x.putExtra("DATA_FRASES_CELEBRES", arreglos[0]);
                        startActivity(x);
                        break;
                    case  2: //blue
                        Intent y = new Intent(MainActivity.this, BlueActivity.class);
                        y.putExtra("DATA_FRASES_CELEBRES", arreglos[1]);
                        startActivity(y);
                        break;
                    case  3: //green
                        Intent z = new Intent(MainActivity.this, GreenActivity.class);
                        z.putExtra("DATA_FRASES_CELEBRES", arreglos[2]);
                        startActivity(z);
                        break;
                }
            }
